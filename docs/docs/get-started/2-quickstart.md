...
- [Concepts](../build/architecture.md) — understand streams, pipelines, and data flow.
- [Configuration reference](../reference/configuration.md) — the full top-level YAML structure.
