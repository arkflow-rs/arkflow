...
- ArkFlow [installed](../getting-started/1-install.md)
- Understand the [job configuration shape](../streaming-jobs.md) — start with
...
HTTP API — are in the [control plane overview](../control-plane/1-overview.md)
and the [operations guide](../control-plane/3-operations.md).
