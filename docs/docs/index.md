...
| You are... | Start with |
|------------|------------|
| Evaluating ArkFlow | [Quickstart](./get-started/2-quickstart.md) → [Architecture](./build/architecture.md) |
| Writing a pipeline | [Streams](./build/streams.md) → [Components](./components/) → [Recipes](./build/recipes/) |
