...
In the [quickstart](../getting-started/2-quickstart.md) you built a running
...
**Prerequisites:** the [quickstart](../getting-started/2-quickstart.md)
...
- [Delivery semantics](../concepts/4-delivery-semantics.md) — at-least-once vs
  opt-in exactly-once for transactional sinks.
- [WAL optimization](../concepts/5-wal-optimization.md) — how `sync` modes trade
  latency for throughput.
- [Case: durable webhook collection](../cases/1-webhook-durable.md) — the same
