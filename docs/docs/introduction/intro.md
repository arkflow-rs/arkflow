...
Read [Why ArkFlow](./why-arkflow.md) for the positioning and trade-offs
versus stateless routers and distributed stream engines.
...
- [Operations](../operations/control-plane/1-overview.md) — deploy and operate ArkFlow as a fleet.
