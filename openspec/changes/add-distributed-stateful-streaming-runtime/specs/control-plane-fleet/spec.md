...
The Hub SHALL expose Node, Stream, configuration version, Operation, Audit Event, Rollout, Job, Task, and Checkpoint resources with stable identifiers and explicit desired, observed, and convergence data where applicable.
